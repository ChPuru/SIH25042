                        ...
                        <div className="before-after-container">
                            <div className="before-after-wrapper">
                                ...
                                <div
                                    ...
                                    data-after-width={slider}
                                />
                            </div>
                            <label htmlFor="slider-range" className="slider-label">{t('satellite.slider_label') || 'Adjust comparison'}</label>
                            <input
                                id="slider-range"
                                type="range"
                                min={0}
                                ...
                                title={t('satellite.slider_title') || 'Adjust before/after comparison'}
                            />
                        </div>
                    )}
